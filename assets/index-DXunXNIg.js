 ...
 */var si=k;function G2(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var Y2=typeof Object.is=="function"?Object.is:G2,q2=si.useSyncExternalStore,Q2=si.useRef,X2=si.useEffect,J2=si.useMemo,Z2=si.useDebugValue;ty.useSyncExternalStoreWithSelector=function(e,t,n,r,o){var i=Q2(null);if(i.current===null){var s={hasValue:!1,value:null};i.current=s}else s=i.current;i=J2(function(){function l(v){if(!u){if(u=!0,c=v,v=r(v),o!==void 0&&s.hasValue){var g=s.value;if(o(g,v))return d=g}return d=v}if(g=d,Y2(c,v))return g;var y=r(v);return o!==void 0&&o(g,y)?g:(c=v,d=y)}var u=!1,c,d,p=n===void 0?null:n;return[function(){return l(t())},p===null?void 0:function(){return l(p())}]},[t,n,r,o]);var a=q2(e,i[0],i[1]);return X2(function(){s.hasValue=!0,s.value=a},[a]),Z2(a),a};ey.exports=ty;var eL=ey.exports,Ze="default"in wl?Vm:wl,vf=Symbol.for("react-redux-context"),xf=typeof globalThis<"u"?globalThis:{};function tL(){if(!Ze.createContext)return{};const e=xf[vf]??(xf[vf]=new Map);let t=e.get(Ze.createContext);return t||(t=Ze.createContext(null),e.set(Ze.createContext,t)),t}var Mn=tL(),nL=()=>{throw new Error("uSES not initialized!")};function Jc(e=Mn){return function(){return Ze.useContext(e)}}var ny=Jc(),ry=nL,rL=e=>{ry=e},oL=(e,t)=>e===t;function iL(e=Mn){const t=e===Mn?ny:Jc(e),n=(r,o={})=>{const{equalityFn:i=oL,devModeChecks:s={}}=typeof o=="function"?{equalityFn:o}:o,{store:a,subscription:l,getServerState:u,stabilityCheck:c,identityFunctionCheck:d}=t();Ze.useRef(!0);const p=Ze.useCallback({[r.name](g){return r(g)}}[r.name],[r,c,s.stabilityCheck]),v=ry(l.addNestedSub,a.getState,u||a.getState,p,i);return Ze.useDebugValue(v),v};return Object.assign(n,{withTypes:()=>n}),n}var sL=iL();function aL(e){e()}function lL(){let e=null,t=null;return{clear(){e=null,t=null},notify(){aL(()=>{let n=e;for(;n;)n.callback(),n=n.next})},get(){const n=[];let r=e;for(;r;)n.push(r),r=r.next;return n},subscribe(n){let r=!0;const o=t={callback:n,next:null,prev:t};return o.prev?o.prev.next=o:e=o,function(){!r||e===null||(r=!1,o.next?o.next.prev=o.prev:t=o.prev,o.prev?o.prev.next=o.next:e=o.next)}}}}var wf={notify(){},get:()=>[]};function uL(e,t){let n,r=wf,o=0,i=!1;function s(y){c();const w=r.subscribe(y);let m=!1;return()=>{m||(m=!0,w(),d())}}function a(){r.notify()}function l(){g.onStateChange&&g.onStateChange()}function u(){return i}function c(){o++,n||(n=t?t.addNestedSub(l):e.subscribe(l),r=lL())}function d(){o--,n&&o===0&&(n(),n=void 0,r.clear(),r=wf)}function p(){i||(i=!0,c())}function v(){i&&(i=!1,d())}const g={addNestedSub:s,notifyNestedSubs:a,handleChangeWrapper:l,isSubscribed:u,trySubscribe:p,tryUnsubscribe:v,getListeners:()=>r};return g}var cL=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",dL=typeof navigator<"u"&&navigator.product==="ReactNative",pL=cL||dL?Ze.useLayoutEffect:Ze.useEffect;function fL({store:e,context:t,children:n,serverState:r,stabilityCheck:o="once",identityFunctionCheck:i="once"}){const s=Ze.useMemo(()=>{const u=uL(e);return{store:e,subscription:u,getServerState:r?()=>r:void 0,stabilityCheck:o,identityFunctionCheck:i}},[e,r,o,i]),a=Ze.useMemo(()=>e.getState(),[e]);pL(()=>{const{subscription:u}=s;return u.onStateChange=u.notifyNestedSubs,u.trySubscribe(),a!==e.getState()&&u.notifyNestedSubs(),()=>{u.tryUnsubscribe(),u.onStateChange=void 0}},[s,a]);const l=t||Mn;return Ze.createElement(l.Provider,{value:s},n)}var mL=fL;function oy(e=Mn){const t=e===Mn?ny:Jc(e),n=()=>{const{store:r}=t();return r};return Object.assign(n,{withTypes:()=>n}),n}var hL=oy();function gL(e=Mn){const t=e===Mn?hL:oy(e),n=()=>t().dispatch;return Object.assign(n,{withTypes:()=>n}),n}var yL=gL();rL(eL.useSyncExternalStoreWithSelector);const qe=yL,W=sL,vL=()=>{const e=qe();return k.useLayoutEffect(()=>{e(xr("ErrorPage"))},[]),x.jsx("div",{className:"flex w-full h-screen justify-center items-center",children:"You have encountered an error"})},xL=k.memo(({character:e})=>{const t=k.useRef(null);return k.useEffect(()=>{const n=()=>{t.current&&(t.current.style.transform=`rotate(${window.scrollY/10}deg)`)};window.addEventListener("scroll",n,!0)},[]),x.jsx("img",{ref:t,className:`\r
      ...
      4k:w-[6.250rem]\r
    `,src:e,alt:"Character_1_svg"})}),wL=k.memo(({item:e,imgURLBase:t,imgAlternate:n})=>{const r=qe(),o=W(U2);let i="",s="";switch(e){case"Home":i="Home",s=`
      w-[1.841rem] 
      mobile:w-[2.455rem] 
      sMobile:w-[3.928rem] 
      mMobile:w-[4.714rem] 
  ...
  `,children:[x.jsx(xL,{character:r}),x.jsx("div",{className:`\r
      ...
      4k:min-h-[4.141rem]`})]})}),bL=()=>{const e=qe(),t=k.useContext(Ce),{tabRef:n,backgroundSelectRef:r}=t,o=W(ii),i=W(Y0);if(n.current.length!==0){const a=n.current.filter(l=>l.innerText===o)[0].offsetLeft;r.current.style.left=`${a}px`}k.useEffect(()=>{function s(){i!==window.innerWidth&&e($2())}return window.addEventListener("resize",s),s(),()=>window.removeEventListener("resize",s)},[])},SL=k.memo(()=>(bL(),x.jsxs("main",{className:`\r
      block\r
      relative w-full \r
      min-h-dvh\r
      overflow-x-hidden\r
...
\r
          ...
          `,children:[x.jsx("span",{className:"text-SiteYellow",children:"T"}),"o ",x.jsx("span",{className:"text-SiteYellow",children:"M"}),"y ",x.jsx("span",{className:"text-SiteYellow",children:"P"}),"ortfolio"]}),x.jsx("img",{"data-aos":"fade","data-aos-duration":"1250","data-aos-delay":"800",className:`
            ...
            `,src:LL,alt:""}),x.jsx("div",{className:"circle1"}),x.jsx("div",{className:"circle2"}),x.jsx("div",{className:"circle3"}),x.jsx("div",{className:"circle4"})]})})]})}),PL=k.memo(()=>{const e=k.useContext(Ce),{triangle:t,mobileTriangle:n,profile:r,bracketLeft:o,bracketRight:i,moneySign:s}=e,a=W(Y0);return x.jsxs("div",{className:`\r
    partOneCSS\r
...
\r
      font-medium\r
      `,children:["Years Experience: ",e.years]})]})}),DL=k.memo(({skill:e,loc:t})=>{const n=qe(),r=k.useContext(Ce),{iconsRef:o,arrowRef:i,descRef:s}=r,a=W(H0);return k.useEffect(()=>{const l=()=>{var v;if(n(w2(e.title)),!i.current)return;const u=o.current[t].offsetLeft+o.current[t].offsetWidth/2,c=((v=i.current)==null?void 0:v.offsetWidth)/2,d=u-c,p=s.current.offsetWidth;i.current.style.left=`${(d/p*100).toFixed(2)}%`};return o.current[t].addEventListener("mouseover",l,!0),()=>{o.current[t].removeEventListener("mouseover",l,!0)}},[]),x.jsx("img",{ref:l=>o.current[t]=l,className:`
      cursor-pointer
      w-[2.591rem]
      mobile:w-[3.455rem]
      sMobile:w-[5.528rem]
...
\r
        ...
        largeDesktop:right-[-2rem] largeDesktop:top-[-20rem]`,src:n,alt:""})]})}),jL=k.memo(()=>{const e=k.useContext(Ce),{pageRef:t}=e;return x.jsxs("div",{ref:n=>{n&&(t.current.AboutMe=n)},id:"AboutMe",className:`
    relative 
    w-full`,children:[x.jsx(PL,{}),x.jsx(RL,{})]})}),NL=k.memo(()=>{const e=qe(),t=W(ii),n=k.useContext(Ce),{tabRef:r,backgroundSelectRef:o}=n,i=["Programming","Art","UI / UX"],s=(a,l)=>{e(j2(a));const u=r.current[l].offsetLeft;o.current.style.left=`${u}px`};return x.jsxs("div",{className:`\r
    flex \r
    flex-row \r
    w-full\r
    relative\r
...
\r
            ...
            `,children:[x.jsx("h1",{className:`\r
                ...
                leading-none\r
                opacity-80\r
                `,children:r})]})]}),eC=k.memo(({project:e})=>{const{id:t,projectName:n,projectURL:r,imgURL:o,date:i,tags:s,live:a,responsive:l}=e;return x.jsxs(Ev.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.5},onClick:()=>window.open(r),className:`\r
        block\r
        relative\r
\r
        w-[7.311rem]\r
