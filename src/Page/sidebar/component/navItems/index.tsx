...
const index = memo((
  ...
  switch (item) {
    case 'Home':
      section="Home"
      imgcss = `w-[1.8749rem] sMobile:w-[2.9988rem] mMobile:w-[3.6rem] sLaptop:w-[2.133rem] mLaptop:w-[2.667rem] desktop:w-[3.2rem] largeDesktop:w-[4rem]`
      break;
    case 'About Me':
      section="AboutMe"
      imgcss = `w-[1.2401rem] sMobile:w-[1.983373rem] mMobile:w-[2.381rem] sLaptop:w-[1.40238rem] mLaptop:w-[1.74636rem] desktop:w-[2.1168rem] largeDesktop:w-[2.646rem]`
      break;
    case 'Portfolio':
      section = "Portfolio"
      imgcss = `w-[1.2937rem] sMobile:w-[2.069172rem] mMobile:w-[2.484rem] sLaptop:w-[1.472rem] mLaptop:w-[1.84rem] desktop:w-[2.208rem] largeDesktop:w-[2.76rem]`
      break;
    case 'Contact Me':
      section = "ContactMe"
      imgcss = `w-[1.6874rem] sMobile:w-[2.69892rem] mMobile:w-[3.24rem] sLaptop:w-[1.92rem] mLaptop:w-[2.4rem] desktop:w-[2.88rem] largeDesktop:w-[3.6rem]`
      break;
  }
  ...
  return (
    <Link className="h-full" to={'/Newportfolio-ReactViteBuild/'}>
        ...
        ${currentSection !== section  ? `cursor-pointer hover:opacity-75`: 'cursor-default'}
         gap-[.3255rem] sMobile:gap-[0.520625rem] mMobile:gap-[0.625rem] sLaptop:gap-[0.333rem] mLaptop:gap-[0.417rem] desktop:gap-[0.5rem] largeDesktop:gap-[0.625rem]`}
        >
